	...
	<main style="min-height: 100vh; max-width: 100%;">
            ...
            <div style="margin: 20px 13%;">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" value="Chọn nhiều đáp án" readonly  type="text" name="dang_cau_hoi" id="">
                </div>
                <?php 
                    $n = $_SESSION['slda'];
                    for($i = 1; $i <= $n; $i++){
                        ...
                        echo "
                            <div style='margin: 20px 0 0 0;' class='input-group mb-3'>
                                <div class='input-group-text'>
                                    <input name='$i' value='$i' type='checkbox' $chon>
                                </div>
                    ...
                    if(isset($_POST['btn'])){
                        ...
                        if($a1[0] == 0){
                            ...
                            if($check){
                                ...
                                $rs = themCauHoiMotDapAn($tenCauHoi, $da1, $anh, $idKH, 3);
                                if($rs){

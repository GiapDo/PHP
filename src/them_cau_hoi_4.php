        ...
        ?>
            ...
            <div style="margin: 20px 13%;">
                <div class="form-group">
                    ...
                    <!-- <input class="form-control" size="50"  type="text" name="ten_cau_hoi" id="" value="<?php if(isset($_POST['ten_cau_hoi'])){ echo $_POST['ten_cau_hoi'];} if(isset($_SESSION['tencauhoi'])){ echo $_SESSION['tencauhoi'];} ?>"> -->
                    <textarea class="form-control" name="ten_cau_hoi" id="" rows="4" maxlength="255">
                        <?php
                            if (isset($_POST['ten_cau_hoi'])) {
                                echo ($_POST['ten_cau_hoi']);
                            }
                        ?>
                    </textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" value="Sắp xếp lại" readonly  type="text" name="dang_cau_hoi" id="">
                </div>
                <div id ='hienthi'>
                    <div id = 'dapan'>
                        <?php 
                        ...
                        if(isset($_POST['btn'])){
                            ...
                            if($a1[0] == 0){
                                ...
                                if($check){
                                    ...
                                    $rs = themCauHoiMotDapAn($tenCauHoi, $da1, $anh, $idKH, 4);
                                    if($rs){
                                        echo "<div class='alert alert-success text-center' role='alert'>Thêm câu hỏi thành công</div>";
                                    }else{
                                        echo "<div class='alert alert-warning text-center' role='alert'>Thêm câu hỏi thất bại</div>";
